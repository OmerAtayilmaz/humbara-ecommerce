...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h3 class="m-0 font-weight-bold card-title-text">Course Review List</h3>
        </div>
        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td class="d-flex align-items-center justify-content-between border-0">
                                            <a href="{{route('admin.course.reviews.delete',['reviewid'=>$review->id])}}" onclick="return confirm('Are you sure you want to delete')"="delete-course-review"><i class="fas fa-trash fa-lg text-danger"></i></a>
                                        </td>
                                    </tr>
                                   @endforeach
